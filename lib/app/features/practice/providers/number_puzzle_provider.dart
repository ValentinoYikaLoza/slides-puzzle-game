...
class NumberPuzzleStateNotifier extends StateNotifier<NumberPuzzleState> {
  NumberPuzzleStateNotifier() : super(NumberPuzzleState());
...
final numberPuzzleProvider =
    StateNotifierProvider<NumberPuzzleStateNotifier, NumberPuzzleState>((ref) {
  return NumberPuzzleStateNotifier();
});
